...
\chapter{Executive Summary}\label{sec-exec-sum}

\section{Assessment Model}\label{assessment-model}

\section{Reference Points, Stock Status, and
...
\section{Stock ID}\label{stock-id}

\section{Management History}\label{management-history}

\section{Fishery Descriptions}\label{fishery-descriptions}
...
\section{Indices and Standardization}\label{indices-and-standardization}

\section{Composition Data}\label{composition-data}

\section{Absolute Abundance}\label{absolute-abundance}

\section{Environmental/Ecosystem Indicator
Data}\label{environmentalecosystem-indicator-data}

\newpage{}

\chapter{Assessment}\label{sec-assmt-config}

\section{Current Modeling Approach}\label{current-modeling-approach}

\section{Configuration of the Base
...
\section{Modeling Results}\label{sec-assmt-results}
...
\section{Sensitivity Analyses}\label{sec-assmt-sens}

\newpage{}

\section{Management Benchmarks}\label{sec-assmt-bench}

\newpage{}

\section{Projections}\label{sec-assmt-proj}
...
\chapter{References}\label{sec-refs}
