...
\pandocbounded{\includegraphics[keepaspectratio,alt="Abundance at age plot alt text here."]{SAR_species_skeleton_files/figure-pdf/fig-pop.naa-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt="Biomass timeseries plot alternative text here."]{SAR_species_skeleton_files/figure-pdf/fig-spawning.biomass-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt="generic inserted plot alt text here."]{figures/generic_plot.png}}

}

\caption{\label{fig-generic_plot}My example figure produced from the
cars data.}
