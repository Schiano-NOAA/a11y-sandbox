...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Line graph showing biomass time series. The x axis shows the year, which spans from 1874 to 2022. The y axis shows biomass in mt, which spans from 5420.45 to 42648.7.'}]{SAR_species_skeleton_files/figure-pdf/fig-biomass-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Line graph showing model-estimated spawning stock biomass. The x axis shows the year, which spans from 1876 to 2022. The y axis shows model-estimated spawning stock biomass in mt, which spans from 1.3 to 15357.1.'}]{SAR_species_skeleton_files/figure-pdf/fig-spawning.biomass-1.pdf}}
