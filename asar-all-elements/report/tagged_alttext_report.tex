...
Adding rnandom glosary entries to test the feature. \gls{fmsy} .
\gls{abc} , \gls{ai}
...
\begin{table}
\caption{Landings over time for example data by fleet. Subset for only 10 years.}\tabularnewline

\fontsize{12.0pt}{14.4pt}\selectfont
\begin{tabular*}{\linewidth}{@{\extracolsep{\fill}}rrrrr}
\toprule
year & Fishery\_current & Discard\_historical & Fishery\_historical & Fishery\_tribal \\ 
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'Line graph showing biomass time series. The x axis shows the year, which spans from 1914 to 2018. The y axis shows biomass in metric tons, which spans from 20016 to 29359.3.'}]{SAR_species_skeleton_files/figure-pdf/fig-biomass-1.png}}

}

\caption{\label{fig-biomass}Biomass (B) time series. The horizontal
dashed line represents the limit reference point (msy metric tons).}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={'This is the alterantive text for the generic plot that did not get inserted using the fuinction'}]{figures/generic_plot.png}}

}

\caption{\label{fig-generic_plot}Your caption here}
