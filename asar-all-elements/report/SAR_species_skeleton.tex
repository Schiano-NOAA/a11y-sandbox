...
\caption{Landings over time for example data by fleet. Subset for only
10 years.}\tabularnewline
\toprule\noalign{}
...
\pandocbounded{\includegraphics[keepaspectratio]{figures/generic_plot.png}}
