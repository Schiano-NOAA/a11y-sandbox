...
\caption{\label{tbl-format-gt}This is a basic caption for the table with
formatting.}
...
\caption{\label{tbl-no-format-kbl}This is a basic caption for the table
without formatting for a kable table.}
...
\caption{\label{tbl-format-kbl}This is a basic caption for the table
with formatting for a kable table.}
